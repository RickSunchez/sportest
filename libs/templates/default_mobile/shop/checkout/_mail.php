...
<p>Благодарю Вас за заказ в магазине <?= link_to('homepage') ?></p>

<p>Код вашего заказа: <?= $order->getNumber() ?></p>
<p>Выбранный способ оплаты: <b><?= $basket->getPayment()->getName(); ?></b></p>

<p><b>Состав вашего заказа:</b></p>
    ...
    <tr>
        <td colspan="2">
            <? if ($basket->getDiscount()->isValid()): ?>
                <span style="color: #FF0000;"><?= $order->getDiscount()->getLabel() ?></span>
            <? endif; ?>
        </td>
...
<p>
    Оформлено с мобильной версии сайта.
</p>
