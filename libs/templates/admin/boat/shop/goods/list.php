<div ng-controller="GoodsListCtrl" ng-init='init()'>
    ...
    <table class="table table-condensed table-bordered table-hover table-middle table-edit">
        <tr>
            ...
            <th class="i-center-td" width="30"><i class="glyphicon glyphicon-sort-by-attributes-alt"></i></th>
            <th width="20"></th>
        </tr>
        <tr ng-repeat="item in goods">
            ...
            <td ><input ng-model="item.delivery" class="form-control text-center" ng-blur="saveGoods(item)"/>
            </td>
            ...
            <td class="i-center-td">
                <input ng-model="item.pos" class="form-control pos_input" ng-blur="change_pos(item)"/>
            </td>
            <td>
                <div class="btn-group">
