<div ng-controller="NewsListCtrl" ng-init='init()'>
    <div class="clearfix">
        <a class="btn btn-info btn-xs"
           href="<?= link_to('admin_news', array('action' => 'add')); ?>"
    ...
    <div>
        <div>Кол-во новостей: <?= $pagination->getItemCount() ?></div>
    </div>
    ...
    <table class="table table-condensed table-bordered table-hover">
        ...
        <tr ng-repeat="item in news">
            ...
            <td><a href="<?= link_to('admin_news', array('action' => 'edit')) ?>?id={{item.id}}">{{item.name}}</a></td>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li>
                            <a href="<?= link_to('admin_news', array('action' => 'edit')) ?>?id={{item.id}}">
...
<script type="text/javascript">
    window._news = <?= $news? \Delorius\Utils\Json::encode((array)$news): '[]' ?>;
