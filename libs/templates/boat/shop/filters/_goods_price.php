<aside class="sr-block sr-block_feature">
    <input id="sr-feature-<?= $filter->pk(); ?>" type="checkbox" checked class="sr-cb">
    <label for="sr-feature-<?= $filter->pk(); ?>" class="sr-label">
        <?= $filter->name ?>
    </label>

    <div class="sr-body sr-body_price">

        <div class="b-filter-price__value">
            <div class="b-filter-price__with">
                от <span id="slider-price-val1"><?= $price_min ?></span>p.
            </div>
            <div class="b-filter-price__to">
                до <span id="slider-price-val2"><?= $price_max ?></span>p.
            </div>
        </div>
    ...
    $(function () {
        $('#slider-price').slider({
            ...
            slide: function (event, ui) {
                ...
                $('#slider-price-val1').text(min);
                $('#slider-price-val2').text(max);
