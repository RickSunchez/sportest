...
class Valid extends Validators {
    ...
    {
        return (bool) Strings::match((string) $value,$expression );
    }
    ...
    public static function exact_length($value, $length)
    {
        if (is_array($length))
        {
            ...
            {
                if (Strings::length($value) === $strlen)
                    return TRUE;
            }
            return FALSE;
        }
    ...
    public static function email($email, $strict = FALSE)
    {
        ...
        return (bool) Strings::match((string) $email,$expression);
    }
    ...
    public static function alpha($str, $utf8 = FALSE)
    {
        ...
        if ($utf8 === TRUE)
        {
            return (bool) Strings::match($str,'/^\pL++$/uD');
        }
        else
        {
    ...
    public static function alpha_numeric($str, $utf8 = FALSE)
    {
        if ($utf8 === TRUE)
        {
            return (bool) Strings::match($str,'/^[\pL\pN]++$/uD');
        }
        else
        {
    ...
    public static function alpha_dash($str, $utf8 = FALSE)
    {
        ...
        return (bool) Strings::match($str,$regex);
    }
    ...
    public static function digit($str, $utf8 = FALSE)
    {
        if ($utf8 === TRUE)
        {
            return (bool) Strings::match($str,'/^\pN++$/uD');
        }
        else
        {
    ...
    public static function numeric($str)
    {
        ...
        return (bool) Strings::match((string) $str,'/^-?+(?=.*[0-9])[0-9]*+'.preg_quote($decimal).'?+[0-9]*+$/D');
    }
    ...
    public static function decimal($str, $places = 2, $digits = NULL)
    {
        ...
        return (bool) Strings::match($str,'/^[+-]?[0-9]'.$digits.preg_quote($decimal).'[0-9]{'.( (int) $places).'}$/D');
    }
    ...
    {
        return (bool) Strings::match($str,'/^#?+[0-9a-f]{3}(?:[0-9a-f]{3})?$/iD');
    }
