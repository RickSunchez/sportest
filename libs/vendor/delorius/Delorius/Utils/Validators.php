...
use Delorius\Exception\AssertionException;
...
class Validators extends Object
{
    ...
    protected static $counters = array(
        'string' => 'strlen',
        'unicode' => array('Delorius\Utils\Strings', 'length'),
        'array' => 'count',
        'list' => 'count',
        'alnum' => 'strlen',
        'alpha' => 'strlen',
    ...
    {
        return (bool)preg_match('/^[\da-z]{32}$/i', $value);
    }
     ...
     * @return bool
     */
    public static function isText($value, $min = 1, $max = 100)
    {
        return (bool)(Strings::length($value) >= $min AND Strings::length($value) <= $max);
    }
     ...
     * @return bool
     */
    public static function isRU($value)
    {
