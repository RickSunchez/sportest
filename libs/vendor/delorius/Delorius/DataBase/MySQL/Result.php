<?php
namespace Delorius\DataBase\MySQL;
/**
...
use Delorius\DataBase\Result as DefaultResult;

class Result extends DefaultResult {

	protected $_internal_row = 0;
    protected $_object_params = array('id'=>NULL,'isFilter'=>false);
	...
	public function current()
	{
		...
		elseif (is_string($this->_as_object))
		{
			...
			$orm = mysqli_fetch_object($this->_result, $this->_as_object, $this->_object_params);
            if($orm)
                $orm->isLoadIn();
            return $orm;
		}
