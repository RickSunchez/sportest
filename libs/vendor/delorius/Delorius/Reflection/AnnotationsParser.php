...
final class AnnotationsParser
{
	...
	{
		throw new  Error('Not use AnnotationsParser::__construct()');
	}
	...
	{
		if (empty($name)) {
			throw new InvalidArgument('Class name must not be empty.');
	...
	{
		if (Strings::match($code, '#//delorius'.'loader=(\S*)#')) {
			return;
		}
	 ...
	 * @return void
	 */
	public static function setCacheStorage(\Delorius\Caching\IStorage $storage)
	{
	...
	/**
	 * @return \Delorius\Caching\IStorage
	 */
	...
	{
		return new Cache(static::getCacheStorage(), 'Delorius.Reflection.Annotations');
	}
