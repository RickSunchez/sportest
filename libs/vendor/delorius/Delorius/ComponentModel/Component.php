...
abstract class Component extends Object implements IComponent
{
	...
	public function lookup($type, $need = TRUE)
	{
		...
		if ($need && $this->monitors[$type][0] === NULL) {
			throw new Error("Component '$this->name' is not attached to '$type'.");
		}
	...
	public function setParent(IContainer $parent = NULL, $name = NULL)
	{
		...
		if ($this->parent !== NULL && $parent !== NULL) {
			throw new Error("Component '$this->name' already has a parent.");
		}
	 ...
	 * override this method to disallow a parent change by throwing an Error
	 * @return void
	 * @throws Error
	 */
	...
	{
		throw new Error('Object serialization is not supported by class ' . get_class($this));
	}
	...
	{
		throw new Error('Object unserialization is not supported by class ' . get_class($this));
	}
