...
class PHPMailer
{
    ...
    protected function doCallback($isSent, $to, $cc, $bcc, $subject, $body)
    {
        if (!empty($this->action_function)) {
            ...
            if (is_array($this->action_function)) {
                if (method_exists($this->action_function[0], $this->action_function[1])) {
                    call_user_func_array(array($this->action_function[0], $this->action_function[1]), $params);
                }
            } else {
                if (function_exists($this->action_function)) {
