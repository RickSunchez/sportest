...
class DefaultOutputNamingConvention implements IOutputNamingConvention
{
	 ...
	 */
	public static function createCssConvention($prefix = null)
	{
		$convention = new static();
		$convention->setPrefix('cssloader-'.$prefix );
	 ...
	 * @return DefaultOutputNamingConvention
	 */
	public static function createJsConvention($prefix = null)
	{
		$convention = new static();
		$convention->setPrefix('jsloader-'.$prefix);
	 ...
	 * @param array $files
	 * @param \CMS\Core\Component\WebLoader\Compiler $compiler
	 * @return string
	 */
