...
class FileCollection implements IFileCollection
{
     ...
     * Make path absolute
     * @param $path string
     * @throws \CMS\Core\Component\WebLoader\FileNotFoundException
     * @return string
     */
    ...
    public function addFile($file)
    {
        try {
            ...
            Environment::getContext()->getService('logger')->error($e->getMessage(), 'FileCollection');
            df_print_r($e->getMessage());
        }
