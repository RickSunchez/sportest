...
abstract class PaymentBase implements IItems
{
    protected $id;
    protected $name;
    protected $value;
    ...
    public function __construct(ACart $cart = null,$value)
    {
        $this->cart = $cart;
        $this->id = $value['id'];
        $this->name = $value['name'];
        $this->value = $value['value'];
        $this->is_active = $value['status'];
    }
    ...
    {
        return _sf('Способ оплаты: {0}', $this->name);
    }
